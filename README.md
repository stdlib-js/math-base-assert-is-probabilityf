...
```javascript
isProbabilityf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-is-probabilityf@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var isProbabilityf = require( 'path/to/vendor/umd/math-base-assert-is-probabilityf/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-is-probabilityf@v0.1.0-umd/browser.js"></script>
```
